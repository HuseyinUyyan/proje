...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p>Lorem ipsum dolor sit amet. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Suscipit aspernatur accusamus necessitatibus voluptatum, dolore iusto?</p>
      </div>
    </div>
  </div>
  <!-- Neler Yapıyoruz -->

  <div class="container neler">
    <div class="row">

      <h2>Unilancer</h2>

      <div class="col-md-4 solol">
        <img class="sol" src="images/logo.png" alt="">
        <h4>Sosyal Medya</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
        <img class="sol" src="images/icons8-graphic-design-64.png" alt="">
        <h4>Seo</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
        <img class="sol" src="images/huseyin.png" alt="">
        <h4>Web Tasarım</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
      </div>

      <div class="col-md-4">
        <img class="telefon" src="videolar/iphonex.png" alt="">
      </div>

      <div class="col-md-4 sagol">
        <img class="sag" src="images/reklam.png" alt="">
        <h4>Reklamcılık Hizmeti</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
        <img class="sag" src="images/icons8-graphic-design-64.png" alt="">
        <h4>Grafik Tasarım</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
        <img class="sag" src="images/wts-coding.svg" alt="">
        <h4>Logo,Kurumsal Kimlik</h4>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, sunt?</p>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid web">
    <div class="row">
      ...
      <div class="col-md-5 p-3">
        <h2>Web Tasarım</h2>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique veritatis quaerat fugiat ipsum corrupti provident nesciunt quisquam tempore ad animi numquam reprehenderit, perferendis quasi explicabo nemo beatae soluta cupiditate iste? Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa nostrum ad enim voluptas,<br> laborum adipisci, quae distinctio amet dolore praesentium esse quo rem quod doloribus recusandae modi nesciunt natus assumenda?
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique veritatis quaerat fugiat ipsum corrupti provident nesciunt quisquam tempore ad animi numquam reprehenderit, perferendis quasi explicabo nemo beatae soluta cupiditate iste? Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa nostrum ad enim voluptas,<br> laborum adipisci, quae distinctio amet dolore praesentium esse quo rem quod doloribus recusandae modi nesciunt natus assumenda?
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique veritatis quaerat fugiat ipsum corrupti provident nesciunt quisquam tempore ad animi numquam reprehenderit, perferendis quasi explicabo nemo beatae soluta cupiditate iste? Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa nostrum ad enim voluptas,<br> laborum adipisci, quae distinctio amet dolore praesentium esse quo rem quod doloribus recusandae modi nesciunt natus assumenda?
        </p>
  ...
  <div class="container diger  ">
    <div class="row">
      <div class="col-md-4">
        ...
        <div class="seo seo1">
          <i class="fa-solid fa-house fa-2x " style="color:orange ;"></i>
          <h3>Seo</h3>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cupiditate pariatur dicta modi incidunt fuga provident repellat aliquam eligendi quod itaque. Assumenda consequatur reiciendis praesentium dolores numquam laboriosam ullam blanditiis dignissimos!
          </p>
      ...
      <div class="col-md-4  ">
        <div class="sosyal sos">
          <i class="fa-brands fa-instagram fa-2x" style="color:pink ;"></i>
          <h3>Sosyal Medya Hizmeti</h3>
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima ea porro sapiente officia neque praesentium debitis! Debitis inventore quod blanditiis placeat numquam. Rerum porro, consectetur sed voluptas quis ipsa? Dolores?
          </p>
        </div>
      </div>
      <div class="col-md-4 ">
        <div class="uı">
          ...
          <h3>UI UX Tasarım</h3>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et repudiandae officiis, deleniti animi quod sequi nulla dolorum nobis dignissimos similique quisquam voluptatem quae alias vel beatae, numquam excepturi libero corrupti!
          </p>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="bos1">
          ...
          <h3>Seo</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique minus, perferendis cum eaque mollitia aliquid fugiat cumque error sint ab dolor repellat, architecto a ut voluptas saepe laborum. Pariatur, eius?
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="bos">
          ...
          <h3>Seo</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem, ipsum fugit tenetur iste ipsa hic beatae, doloremque distinctio qui eius repudiandae quae a dolorem autem animi quis enim, voluptatibus quisquam!
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="reklam">
          <i class="fa-solid fa-house fa-2x " style="color:orange ;"></i>
          <h3>Reklamcılık Hizmeti</h3>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Temporibus inventore ipsa praesentium aliquam, modi, ex expedita nulla voluptatum dicta porro vero laudantium magni odio consequatur officia earum necessitatibus officiis molestias?
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- Örnek Projeler  -->
  <div class="ornek-projeler container ">
    ...
    <h4 style="text-align:center ;"><a style="text-align:center ;" href="http://">Tümünü Gör</a></h4>
    ...
    <div class="row">
      <div class="col">
        <div class="overlay-fade">
          <img src="images/goksentrans.png">
          <div>
            <a href="#">READ MORE</a>
      ...
      <div class="col">
        <div class="overlay-fade">
          <img src="images/hillsigorta.png">
          <div>
            <a href="#">READ MORE</a>
