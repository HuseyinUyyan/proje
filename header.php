...
<body>
    ...
    <body>
        <div class="superNav border-bottom py-2" style="border-color:#4169E1 ;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 centerOnMobile">
                        <select class="me-3 " style="border-color:white; background-color:#4169E1 ; border-width:1px; color:white;">
                            <option value="en-us">EN-US</option>
                            <option value="en-us">TR-tr</option>
                            <option value="en-us">DE-de</option>
                        </select>
                        <span class="d-none d-lg-inline-block d-md-inline-block d-sm-inline-block d-xs-none me-3"><strong>info@unilancer.com</strong></span>
            ...
            <div class="container">
                ...
                <div class="mx-auto my-3 d-lg-none d-sm-block d-xs-block">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-primary" style="color:#4169E1">
                ...
                <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                    <div class="ms-auto d-none d-lg-block">
                        <div class="input-group">
                            <span class="border-primary input-group-text bg-primary text-white"><i class="fa-solid fa-magnifying-glass"></i></span>
                            <input type="text" class="form-control border-primary" style="color:#4169E1" placeholder="Ara">
                            <button class="btn btn-primary text-white">Ara</button>
                        </div>
                    </div>
                    <ul class="navbar-nav ms-auto ">
                        <li class="nav-item">
                            <a class="nav-link mx-2 text-uppercase active" href="index.php">Anasayfa</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-2 text-uppercase" href="#">S.S.S</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav ms-auto ">
                        <li class="nav-item">
